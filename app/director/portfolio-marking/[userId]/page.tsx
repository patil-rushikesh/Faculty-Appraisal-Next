...
export default function DirectorPortfolioMarkingPage() {
        ...
        const fetchAppraisalData = async () => {
            ...
            try {
                ...
                if (response.data.success) {
                    ...
                    setDirectorMarks(data.partD?.directorMarks || 0);
                } else {
    ...
    const calculateTotalScore = () => {
        ...
        const dirScore = Math.min(60, Number(directorMarks) || 0);

        if (appraisalData.partD.isAdministrativeRole) {
            return 0;
        }

        return Math.min(120, selfScore + dirScore);
    };
    ...
    return (
        <div className="container mx-auto p-6 max-w-6xl">
            ...
            >
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800">
                            Portfolio Evaluation (Director)
                        </h1>
                        <p className="text-gray-600 mt-1">
                            Review and mark portfolio for appraisal year {appraisalData.appraisalYear}
                        </p>
                    </div>
                    <Button
                        onClick={() => router.back()}
                ...
                <Card className="mb-6 border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {[
                                { label: "User ID", value: appraisalData.userId },
                ...
                <Card className="mb-6">
                    <CardHeader>
                        <CardTitle>Director Evaluation Marks</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <DialogContent>
                    ...
                    <div className="py-4">
                        <div className="space-y-2">
                            <p className="text-sm">
                                <span className="font-semibold">User ID:</span> {appraisalData.userId}
                            </p>
                            <p className="text-sm">
                                <span className="font-semibold">Director Marks:</span> {directorMarks} / 60
                            </p>
                            <p className="text-sm">
